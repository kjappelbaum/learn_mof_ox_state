...
RACSDATAPATH = (
    "/scratch/kjablonk/oxidationstates/machine_learn_oxstates/data/df_racs_cleaned.csv"
)
FEATURESPATH = (
    "/scratch/kjablonk/oxidationstates/machine_learn_oxstates/data/20190928_features"
)
...
def main(create_featuresets, run_model_selection, submit):
    for name, featureset in FEATURE_SETS:
        ...
        if submit:
            subprocess.call(
                "sbatch submit_{}_{}.slurm".format(name, command), shell=True
            )
