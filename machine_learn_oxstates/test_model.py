...
from machine_learn_oxstates.metrics import bootstrapped_metrics, return_scoring_funcs
...
def main(
    modelpath, scalerpath, xpath, ypath, namepath, outpath, featurelabelpath
):  # pylint:disable=too-many-arguments
